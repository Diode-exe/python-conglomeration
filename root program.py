...
while True:
    choice = input("Choose 1 for brute forcer (not real hacking tool),"
                   "press 2 for number guessing game, press 3 to start the calculator, press 4 to start the infinite counter, "
